...
# mailcount.sh {
	...
	export TMUX_POWERLINE_SEG_MAILCOUNT_MAILDIR_INBOX="/home/baphled/.mail/inbox/new"
	...
	export TMUX_POWERLINE_SEG_MAILCOUNT_MAILCHECKRC="/home/baphled/.mailcheckrc"
# }
...
# weather.sh {
	...
	TMUX_POWERLINE_SEG_WEATHER_LAT="51.386139"
	TMUX_POWERLINE_SEG_WEATHER_LON="-2.396440"
# }
